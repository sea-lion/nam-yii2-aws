    ...
    <?= GridView::widget([
     ...
     /*       [
            ...
            [
                ...
                //'options' => ['class' => 'col-4'],
                /*'value' => function($row, $index, $widget) {
                    return Html::ul(Document::find()->where(['meeting_id' => $row->id, 'published' => 1])->select('document_type, title, file_name, published')->all(),
                ...
                'value' => function($row) {
                    return Html::a('View All Documents', ['document/index', 'DocumentSearch[meeting_id]' => $row->id, ]);
                },
                'format' => 'html'
            ],
            [
                ...
                //'options' => ['class' => 'col-4'],
                'value' => function($row, $index, $widget){ 
                    return Html::a('View All Issues', ['issue/index', 'IssueSearch[meeting_id]' => $row->id, ]);
                },
                'format' => 'html'
            ],
            /*[
